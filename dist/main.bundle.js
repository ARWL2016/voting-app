...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_toPromise__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__ = __webpack_require__(369);
...
var AuthService = (function () {
    ...
    AuthService.prototype.register = function (user) {
        ...
        var url = this._authUrl + "register";
        return this._http.post(url, user)
            .do(function (response) { return console.log(response); })
            .do(function (response) {
            _this.processAuthToken(response);
        })
    ...
    AuthService.prototype.updateCurrentUser = function (json) {
        console.log('JSON', json);
        var username = json.username;
        this.currentUser = json;
        window.localStorage.setItem('username', username);
    };
    AuthService.prototype.processAuthToken = function (response) {
        console.log('PROCESS AUTH TOKEN', response);
        var headers = response.headers.toJSON();
        var token = headers['x-auth'][0];
    ...
    AuthService.prototype.logout = function () {
        ...
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ 'x-auth': token });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: headers });
        var url = this._authUrl + "logout";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser_animations__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ng2_charts__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ng2_charts___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_ng2_charts__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_component__ = __webpack_require__(228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__index_index_component__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__auth_login_login_component__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_data_service__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_auth_service__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_app_topic_topic_component__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__create_topic_create_topic_component__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__auth_registration_registration_component__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_app_services_create_topic_guard_service__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_toastr_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__chart_chart_component__ = __webpack_require__(232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__about_about_component__ = __webpack_require__(227);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12_app_topic_topic_component__["a" /* TopicComponent */],
            __WEBPACK_IMPORTED_MODULE_9__auth_login_login_component__["a" /* LoginComponent */],
            __WEBPACK_IMPORTED_MODULE_13__create_topic_create_topic_component__["a" /* CreateTopicComponent */],
            __WEBPACK_IMPORTED_MODULE_14__auth_registration_registration_component__["a" /* RegistrationComponent */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* RouterModule */].forRoot([
                { path: 'topic/:id', component: __WEBPACK_IMPORTED_MODULE_12_app_topic_topic_component__["a" /* TopicComponent */] },
                { path: 'login', component: __WEBPACK_IMPORTED_MODULE_9__auth_login_login_component__["a" /* LoginComponent */] },
                { path: 'login/register', component: __WEBPACK_IMPORTED_MODULE_14__auth_registration_registration_component__["a" /* RegistrationComponent */] },
                ...
                { path: 'create', canActivate: [__WEBPACK_IMPORTED_MODULE_15_app_services_create_topic_guard_service__["a" /* CreateTopicGuard */]], component: __WEBPACK_IMPORTED_MODULE_13__create_topic_create_topic_component__["a" /* CreateTopicComponent */] },
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_15_app_services_create_topic_guard_service__["a" /* CreateTopicGuard */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_do__ = __webpack_require__(369);
...
var DataService = (function () {
    ...
    DataService.prototype.fetchTopicsByUser = function () {
        var url = this._dataUrl + "current";
        var options = this.addAuthTokenToHeader();
    ...
    DataService.prototype.castVote = function (id, topic) {
        var url = this._dataUrl + "vote/" + id;
        var options = this.addAuthTokenToHeader();
        return this._http.put(url, topic, options)
            .toPromise();
    };
    DataService.prototype.deleteTopic = function (id) {
        var url = "" + this._dataUrl + id;
        var options = this.addAuthTokenToHeader();
        return this._http.delete(url, options)
            .toPromise();
    };
    DataService.prototype.addAuthTokenToHeader = function () {
        var token = window.localStorage.getItem('token');
    ...
    RegistrationComponent.prototype.submitForm = function () {
        ...
        if (this.username) {
            ...
            this._auth.register(this.user)
                ...
                .catch(function (err) {
                _this.error = 'Username is already taken. Please try again.';
            });
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_app_services_data_service__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_topic__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_result__ = __webpack_require__(235);
